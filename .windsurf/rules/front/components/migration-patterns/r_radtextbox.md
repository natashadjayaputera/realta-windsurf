...
- R_RadTextBox.Text → R_TextBox.@bind-Value - See @r_inputcomponentbase.mdc
- R_RadTextBox.Enabled → R_TextBox.Enabled - See @r_controlbase.mdc
...
- R_RadTextBox.R_ConductorSource / R_ConductorGridSource / R_Enable* → See @r_ienablecontrol.mdc (R_ConductorSource also see @r_inputcomponentbase.mdc)
- R_RadTextBox.Name → Not applicable
- R_RadTextBox.Location/Size → Not applicable; use `Class`/`Style`/CSS
- R_RadTextBox.TabIndex → R_TextBox.TabIndex - See @r_controlbase.mdc
