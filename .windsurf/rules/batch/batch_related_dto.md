---
description: "ToCSharpCommon, ToCSharpViewModel, & ToCSharpFront: Batch related DTOs needed for batch data display in .razor.cs and .razor, batch data manipulation in BatchViewModel, and batch data processing in Back Project"
---
