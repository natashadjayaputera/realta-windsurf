...
1.1 Read `{ProgramName}Back` and `{ProgramName}Common` projects to get all report related functions and class.
...
1.5 Create a file named `{yyyyMMdd}_{HHmmss}_{ProgramName}_project_structure_report.md` in `/project-structure/`.

### Phase 2: Get All Batch Related Functions and Class
2.1 Read `{ProgramName}Back` and `{ProgramName}Common` projects to get all batch related functions and class.
...
2.5 Create a file named `{yyyyMMdd}_{HHmmss}_{ProgramName}_project_structure_batch.md` in `/project-structure/`.
...
3.5 Create a file named `{yyyyMMdd}_{HHmmss}_{ProgramName}_project_structure_main.md` in `/project-structure/`.

### Phase 4: Compilation
4.1 All files created in phase 1, 2, and 3 must be copied (NO CHANGES) into `{yyyyMMdd}_{HHmmss}_{ProgramName}_project_structure.md` in `/project-structure/`.
