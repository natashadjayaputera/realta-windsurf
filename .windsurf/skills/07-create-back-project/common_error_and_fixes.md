...
2. Read `back_resources_csproj_template.md` as a template and create `{YOUR_SP_NAME}Resources.csproj` file in `{YOUR_SP_NAME}Resources` folder.
3. Read `back_sp_resources_dummy_class_template.md` and create resource dummy class.
4. Read `back_resources_designer_template.md` and create resource designer class.
