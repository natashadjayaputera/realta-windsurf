---
name: model_csproj_template
description: "Template for Model Projects .csproj"
---
# Project Structure

- Location: `FRONT/{ProgramName}Model/{ProgramName}Model.csproj` (Please not that it is directly inside FRONT folder, not inside a Subfolder of {ModuleName})
